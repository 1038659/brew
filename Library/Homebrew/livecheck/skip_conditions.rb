  ...
  module Livecheck
    ...
    module SkipConditions
      ...
      sig {
        params(
          formula:              Formula,
          _has_livecheck_block: T::Boolean,
          full_name:            T::Boolean,
          verbose:              T::Boolean,
        ).returns(T::Hash[Symbol, T.untyped])
      }
      private_class_method def self.formula_head_only(formula, _has_livecheck_block, full_name: false, verbose: false)
      ...
      private_class_method def self.formula_deprecated(formula, has_livecheck_block, full_name: false, verbose: false)
        return {} if !formula.deprecated? || has_livecheck_block
      ...
      private_class_method def self.formula_disabled(formula, has_livecheck_block, full_name: false, verbose: false)
        return {} if !formula.disabled? || has_livecheck_block
      ...
      private_class_method def self.formula_versioned(formula, has_livecheck_block, full_name: false, verbose: false)
        return {} if !formula.versioned_formula? || has_livecheck_block
      ...
      private_class_method def self.cask_deprecated(cask, has_livecheck_block, full_name: false, verbose: false)
        return {} if !cask.deprecated? || has_livecheck_block
      ...
      private_class_method def self.cask_disabled(cask, has_livecheck_block, full_name: false, verbose: false)
        return {} if !cask.disabled? || has_livecheck_block
      ...
      private_class_method def self.cask_version_latest(cask, has_livecheck_block, full_name: false, verbose: false)
        return {} if !(cask.present? && cask.version&.latest?) || has_livecheck_block
      ...
      private_class_method def self.cask_url_unversioned(cask, has_livecheck_block, full_name: false, verbose: false)
        return {} if !(cask.present? && cask.url&.unversioned?) || has_livecheck_block
      ...
      def self.skip_information(package_or_resource, full_name: false, verbose: false, extract_plist: true)
        ...
        checks.each do |method_name|
          ...
          when :cask_extract_plist
            send(method_name, package_or_resource, has_livecheck_block, full_name:, verbose:, extract_plist:)
          else
            send(method_name, package_or_resource, has_livecheck_block, full_name:, verbose:)
          end
